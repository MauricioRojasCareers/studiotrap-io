...
function SignUpSubmitButton() {
  ...
  return (
    <motion.button
      disabled={pending}
      type="submit"
      className="bg-white/10 text-white font-bold  px-4 rounded-lg hover:bg-white/20 transition-colors"
...
export default function SignUp() {
  ...
  return (
    <section className="flex flex-col items-center h-screen w-screen p-4 bg-gradient-to-b from-[#ffd6ff] to-[#b8c0ff] text-white">
      {/* Studio Trap Title */}
      <motion.h1
...
// {/* <div className="bg-gradient-to-b from-[#ffd6ff] to-[#b8c0ff] text-white h-screen ">
// <section className="flex flex-col w-screen items-center justify-center overscroll-none pt-10 h-screen ">
//   {/* Studio Trap Title */}
//   <motion.h1
//     className="text-5xl font-extrabold tracking-tight sm:text-[5rem] mb-4 "
//     initial={{ opacity: 0, y: -50 }}
